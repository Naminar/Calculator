...
class CalcFrame : public wxFrame
{
    ...
    wxTextCtrl     *scoreboard_1, *scoreboard_2, *program[36], *registers[8], *circular_stack[6];
...
// -------- Creat scoreboard ----------
    ...
    scoreboard_1 = new wxTextCtrl (drawPanel, wxID_ANY, _(""),
                                 wxPoint (54, 25), wxSize (50 + 7 * 52 - 150, 60),
                                 wxTE_LEFT);
    scoreboard_2 = new wxTextCtrl (drawPanel, wxID_ANY, _(""),
                                 wxPoint (54 + 50 +7 * 52 - 150, 25), wxSize (150, 60),
                                 wxTE_RIGHT);
    scoreboard_1->SetFont (wxFontInfo (40));
    scoreboard_2->SetFont (wxFontInfo (40));
    scoreboard_1->SetBackgroundColour (*wxBLACK);
    scoreboard_2->SetBackgroundColour (*wxBLACK);
...
{
    scoreboard_1->Clear();
    *scoreboard_1 << back_end.screen_data.tablo;
    scoreboard_2->Clear();
    *scoreboard_2 << back_end.screen_data.pow;
